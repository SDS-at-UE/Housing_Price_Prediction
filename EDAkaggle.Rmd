...
```{r}
print(select(house, row.names = c("GarageYrBlt", "GarageArea")))
...
ggplot(aes(x = GarageYrBlt, y = SalePrice, color = GarageType), data = house) +
  geom_point()
```
1900-1940 old, 1940-1980 mid, 1980-2010 new
...
How does the relationship between sale price and number of houses in the data per year covary? 
